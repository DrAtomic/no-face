...
def create_mask(img,point,color):
    ...
    """
    # TODO: make mask a better, reincorporate face points from 7c1bbf24a7
    # TODO: create a two part mask, a top and a bottom
    zeros = np.zeros(img.shape,dtype=np.uint8)
    # TODO: make the axis a function of the area from the facepoints
    mask = cv2.ellipse(zeros,point,(125,93),90,0,360,color,-1)
    return mask
...
def edit_face(img):
    ...
    #TODO: mask is a bit abrupt, apply blur to smooth the edges
